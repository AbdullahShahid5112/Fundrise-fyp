...
const ProfilePage =()=>{
    ...
    const file = e.target.files[0]; // Corrected this line
    if (!file) return;
    ...
    reader.onload = async () => {
        ...
        setSelectedImg(base64Image); // Set preview before updating backend

        console.log("Base64 Encoded Image:", base64Image); // Debugging
        ...
        <div className="bg-base-content rounded-xl p-6 space-y-8">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-zinc-400">
              {isUpdateProfile ? "Uploading..." : "Click To Update Image"}
            </p>
          </div>
        </div>
